...
class SmsService
{
     ...
     * @param string $accessKeyId  %ali_sms_access_key%
     * @param string $accessKeySecret %ali_sms_access_key_secret%
     */
    public function __construct($accessKeyId, $accessKeySecret, Tool $tool)
    {
