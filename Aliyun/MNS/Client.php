...
use Liz\AliBundle\Aliyun\MNS\Queue;
use Liz\AliBundle\Aliyun\MNS\Config;
use Liz\AliBundle\Aliyun\MNS\Http\HttpClient;
use Liz\AliBundle\Aliyun\MNS\AsyncCallback;
use Liz\AliBundle\Aliyun\MNS\Model\AccountAttributes;
use Liz\AliBundle\Aliyun\MNS\Requests\CreateQueueRequest;
use Liz\AliBundle\Aliyun\MNS\Responses\CreateQueueResponse;
use Liz\AliBundle\Aliyun\MNS\Requests\ListQueueRequest;
use Liz\AliBundle\Aliyun\MNS\Responses\ListQueueResponse;
use Liz\AliBundle\Aliyun\MNS\Requests\DeleteQueueRequest;
use Liz\AliBundle\Aliyun\MNS\Responses\DeleteQueueResponse;
use Liz\AliBundle\Aliyun\MNS\Requests\CreateTopicRequest;
use Liz\AliBundle\Aliyun\MNS\Responses\CreateTopicResponse;
use Liz\AliBundle\Aliyun\MNS\Requests\DeleteTopicRequest;
use Liz\AliBundle\Aliyun\MNS\Responses\DeleteTopicResponse;
use Liz\AliBundle\Aliyun\MNS\Requests\ListTopicRequest;
use Liz\AliBundle\Aliyun\MNS\Responses\ListTopicResponse;
use Liz\AliBundle\Aliyun\MNS\Requests\GetAccountAttributesRequest;
use Liz\AliBundle\Aliyun\MNS\Responses\GetAccountAttributesResponse;
use Liz\AliBundle\Aliyun\MNS\Requests\SetAccountAttributesRequest;
use Liz\AliBundle\Aliyun\MNS\Responses\SetAccountAttributesResponse;
...
class Client
{
    ...
    /**
     * @return \Liz\AliBundle\Aliyun\MNS\Config
     */
        ...
        $accessKey, $securityToken = NULL, Config $config = NULL)
    {
        ...
        $this->client = new HttpClient($endPoint, $accessId,
            $accessKey, $securityToken, $config, $config->getTool());
    }
    ...
    {
        return new Queue($this->client, $queueName, $base64, $this->getConfig()->getTool());
    }
