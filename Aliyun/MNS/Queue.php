...
use Liz\AliBundle\Aliyun\MNS\Requests\SetQueueAttributeRequest;
use Liz\AliBundle\Aliyun\MNS\Responses\SetQueueAttributeResponse;
use Liz\AliBundle\Aliyun\MNS\Requests\GetQueueAttributeRequest;
use Liz\AliBundle\Aliyun\MNS\Responses\GetQueueAttributeResponse;
use Liz\AliBundle\Aliyun\MNS\Requests\SendMessageRequest;
use Liz\AliBundle\Aliyun\MNS\Responses\SendMessageResponse;
use Liz\AliBundle\Aliyun\MNS\Requests\PeekMessageRequest;
use Liz\AliBundle\Aliyun\MNS\Responses\PeekMessageResponse;
use Liz\AliBundle\Aliyun\MNS\Requests\ReceiveMessageRequest;
use Liz\AliBundle\Aliyun\MNS\Responses\ReceiveMessageResponse;
use Liz\AliBundle\Aliyun\MNS\Requests\DeleteMessageRequest;
use Liz\AliBundle\Aliyun\MNS\Responses\DeleteMessageResponse;
use Liz\AliBundle\Aliyun\MNS\Requests\ChangeMessageVisibilityRequest;
use Liz\AliBundle\Aliyun\MNS\Responses\ChangeMessageVisibilityResponse;
use Liz\AliBundle\Aliyun\MNS\Requests\BatchSendMessageRequest;
use Liz\AliBundle\Aliyun\MNS\Responses\BatchSendMessageResponse;
use Liz\AliBundle\Aliyun\MNS\Requests\BatchReceiveMessageRequest;
use Liz\AliBundle\Aliyun\MNS\Responses\BatchReceiveMessageResponse;
use Liz\AliBundle\Aliyun\MNS\Requests\BatchPeekMessageRequest;
use Liz\AliBundle\Aliyun\MNS\Responses\BatchPeekMessageResponse;
use Liz\AliBundle\Aliyun\MNS\Requests\BatchDeleteMessageRequest;
use Liz\AliBundle\Aliyun\MNS\Responses\BatchDeleteMessageResponse;
...
class Queue
{
    ...
    public function __construct(HttpClient $client, $queueName, $base64 = TRUE, Tool $tool)
    {
    ...
    public function receiveMessage($waitSeconds = NULL)
    {
        ...
        $response = new ReceiveMessageResponse($this->base64, $this->tool);
        return $this->client->sendRequest($request, $response);
    }
