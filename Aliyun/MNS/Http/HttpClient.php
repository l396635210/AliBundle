<?php
namespace Liz\AliBundle\Aliyun\MNS\Http;
...
use Liz\AliBundle\Aliyun\MNS\Requests\BaseRequest;
use Liz\AliBundle\Aliyun\MNS\Responses\BaseResponse;
use Liz\AliBundle\Aliyun\MNS\Signature\Signature;
use Liz\AliBundle\Aliyun\MNS\AsyncCallback;
use GuzzleHttp\Psr7\Request;
use GuzzleHttp\Exception\TransferException;
use Liz\AliBundle\Aliyun\MNS\Responses\MnsPromise;
...
class HttpClient
{
    ...
    public function __construct($endPoint, $accessId,
                                $accessKey, $securityToken = NULL,
                                Config $config = NULL)
    {
        if ($config == NULL)
        {
            $config = new Config($tool);
        }
